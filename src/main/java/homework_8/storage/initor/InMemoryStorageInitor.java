package homework_8.storage.initor;

import homework_8.application.serviceholder.ServiceHolder;
import homework_8.cargo.domain.ClothersCargo;
import homework_8.cargo.domain.FoodCargo;
...
public class InMemoryStorageInitor implements StorageInitor {
    ...
    private ClothersCargo createClothersCargo(int index) {
        ...
        cargo.setName("Clothers_Name_" + (10 - index));
    ...
    private FoodCargo createFoodCargo(int index) {
        ...
        cargo.setName("FoodCargo_Name_" + (10 - index));
        if (index == 2) {
            cargo.setWeight(1);
        } else if (index == 1) {
            cargo.setWeight(2);
